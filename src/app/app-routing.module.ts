...
const routes: Routes = [
  ...
  },
  {
    path: 'register',
    loadChildren: () =>
      import('./pages/setting/registration/registration.module')
        .then(m => m.RegistrationPageModule)
  },
  {
    path: 'forgot-password',
    loadChildren: () =>
      import('./pages/setting/forgot-password/forgot-password.module')
...

  {
    ...
    loadChildren: () =>
      import('./pages/expense/multi-view-expenses/multi-view.module')
        .then(m => m.MultiViewPageModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'multi-expense',
    loadChildren: () =>
      import('./pages/expense/multi-view-expenses/multi-expense/multi-expense.module')
  ...
  },
  {
    path: 'split-view',
    loadChildren: () =>
      import('./pages/expense/split-view/split-view.module')
  ...
  },
  {
    path: 'edit-credit',
    loadChildren: () =>
      import('./cards/credit/edit-credit/edit-credit.module')
        .then(m => m.EditCreditPageModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'edit-debit',
    loadChildren: () =>
      import('./cards/debit/edit-debit/edit-debit.module')
        .then(m => m.EditDebitPageModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'integration',
